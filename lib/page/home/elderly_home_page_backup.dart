...
// import 'elderly_home_page_orders.dart';
...
//           setState(() {
//             _orders = result.data!.results.map((order) => UserOrderData(
//               id: order.id,
//               totalPrice: order.totalPrice,
//               note: order.address,
//               orderStatus: order.orderStatus.toString().split('.').last,
//               elderName: null, // OrderResponse không có elderName
//               orderDetails: order.orderDetails.map((detail) => UserOrderDetail(
//                 productName: detail['productName'] ?? 'Không xác định',
...
//         } else {
//           setState(() {
//             _ordersErrorMessage = result.message ?? 'Không thể tải danh sách đơn hàng';
//             _isLoadingOrders = false;
//           });
//         }
//       } else {
//         setState(() {
//           _ordersErrorMessage = 'Không tìm thấy thông tin người dùng';
//           _isLoadingOrders = false;
//         });
//       }
//     } catch (e) {
//       setState(() {
//         _ordersErrorMessage = 'Lỗi tải đơn hàng: ${e.toString()}';
//         _isLoadingOrders = false;
//       });
//     }
//   }
...
//           // Orders content
//           if (_isLoadingOrders)
//             buildOrdersLoadingState(context)
//           else if (_ordersErrorMessage != null)
//             buildOrdersErrorState(context, _ordersErrorMessage, _loadOrders)
//           else if (_orders.isEmpty)
//             buildOrdersEmptyState(context)
//           else
//             Padding(
//               padding: EdgeInsets.symmetric(horizontal: ResponsiveHelper.getLargeSpacing(context)),
//               child: Column(
...
//                   return Column(
//                     children: [
//                       _buildModernOrderCardFromData(order),
//                       SizedBox(height: ResponsiveHelper.getSpacing(context)),
//                     ],
//                   );
//                 }).toList(),
