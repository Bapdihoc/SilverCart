...
class _CartApiService implements CartApiService {
  ...
  Future<CartReplaceResponse> replaceAllCart(CartReplaceRequest request) async {
    ...
    final _options = _setStreamType<CartReplaceResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<CartGetResponse> getCartByCustomerId(
    ...
    final _options = _setStreamType<CartGetResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<ChangeCartStatusResponse> changeCartStatus(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ChangeCartStatusResponse>(Options(
      method: 'PUT',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<ElderCartsResponse> getAllElderCarts() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ElderCartsResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
