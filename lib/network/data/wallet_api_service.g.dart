...
class _WalletApiService implements WalletApiService {
  ...
  @override
  Future<WalletResponse> getWalletAmount(String userId) async {
  ...
  @override
  Future<CreateOrderResponse> topUpByVnPay(Map<String, dynamic> body) async {
    final _extra = <String, dynamic>{};
  ...
  Future<WithdrawalResponse> requestWithdrawal(
    ...
    final _options = _setStreamType<WithdrawalResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/WithdrawRequest',
