...
part of 'promotion_api_service.dart';
...
class _PromotionApiService implements PromotionApiService {
  _PromotionApiService(this._dio, {this.baseUrl, this.errorLogger});
